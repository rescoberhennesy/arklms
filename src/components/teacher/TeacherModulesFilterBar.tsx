...
interface TeacherModulesFilterBarProps {
...
/**
 * Filter bar for the aggregated /teacher/modules page.
 *
 * URL contract identical to the Grades and Activities filter bars:
 *   ?classId=  - pin to one class (shadows the other three)
 *   ?section=  - exact match
 *   ?track=    - exact match
 *   ?grade=    - exact match on grade_level
 */
export default function TeacherModulesFilterBar({
  classes,
  matchedCount,
  totalCount,
}: TeacherModulesFilterBarProps) {
